...
const FlagTable = ({ flag, flagName }) => {
  return (
    <div className="overflow-x-auto w-full">
      ...
      <table className="table table-zebra table-xs w-full min-w-[800px] table-auto bg-white">
        <thead>
          <tr>
          ...
          {flag.map((each, index) => {
            return (
              <tr key={index} className="hover">
                ...
                <td className="truncate text-slate-700 font-semibold pr-5">{each.value}</td>
