...
import DisplayCode from "../../components/ui/DisplayCode";
import FormControlLabel from "@mui/material/FormControlLabel";
import Checkbox from "@mui/material/Checkbox";
import MethodDetails from "../../components/ui/MethodDetails";
import ClientNameInput from "../../components/ui/ClientNameInput";
import TicketTypeInput from "../../components/ui/TicketTypeInput";
import TransactionTypeSelect from "../../components/ui/TransactionTypeSelect";
...
const riskAssessmentMap = {
  Object: data.riskAssessmentJson,
...
const RiskAssessment = ({ handleChange, disabled }) => {
  const options = ["String", "Object", "Array"];
  return (
    <>
      <FormControlLabel
